...
public class Niveau implements Cloneable {
  ...
  // - que le resultat soit construit avec la méthode clone de la classe parente
  // (pour qu'un clonage
  // profond fonctionne sur toute l'ascendence de l'objet)
  // Le nouvel objet sera de la même classe que l'objet cible du clonage (creation
  // spéciale dans Object)
  @Override
  public Niveau clone() {
    try {
